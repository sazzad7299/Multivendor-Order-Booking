                ...
                <ul class="md:hidden items-center flex flex-wrap list-none">
                    <li class="inline-block relative">
                        ...
                        <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1"
                            ...
                            <a href="#pablo"
                                class="text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-blueGray-700"><i
                                    class="fas fa-long-arrow-alt-up "></i></a><a href="#pablo"
                    ...
                    <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                        <li class="items-center">
                            <a class="text-pink-500 hover:text-pink-600 text-xs uppercase py-3 font-bold block"
                                href="{{ route('admin.home') }}"><i class="fas fa-tv opacity-75 mr-2 text-sm"></i>
                                Dashboard</a>
                        </li>
                        <li class="items-center">
                            <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                                href="{{ route('admin.orderlist')}}"><i class="fas fa-newspaper text-blueGray-400 mr-2 text-sm"></i>
                                Orders</a>
                        </li>
                        <li class="items-center">
                            <a class="text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                                href="{{ route('admin.vendors') }}"><i class="fas fa-user-circle text-blueGray-400 mr-2 text-sm"></i>
                                Vendors</a>
                        </li>
